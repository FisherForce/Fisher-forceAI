...
function suggestLures(species, structure, conditions, spotType, temperature = null) {
  ...
  if (list.length === 0) {
    const defaults = [
      ...
      'Rien ne semble sortir du lot : Tente un shad en linéaire, puis twitching et dandine. Le poisson finira par craquer ! Dit moi ensuite si tu a eu un poisson pour faire progresser l’IA !'s
